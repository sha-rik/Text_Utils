...
export default function Navbar(ek_variable_ka_naam) {
  return (
    ...
    <>
      {/* navbar ke baad tum koi v color ka naam likh sakte ho... aur bg ke baad bhi */}

      {/* hame classname = ko curly bracket me daal diya ...aur double inverted ki jagha ham... back tick ka use kiye so that ham javascript ka use karke likh sake logic ko jo dark mode on/off karega */}
      <nav className={`navbar navbar-expand-lg navbar-${ek_variable_ka_naam.mode} bg-${ek_variable_ka_naam.mode}`}>
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            {/* ye hamne ak radia button use kiya h... so that we can switch between light and dark mode */}
            {/* curly bracket se ham java script likh sakte h */}
